...
function validateManifestShape(value) {
    if (!value || value.app !== "社会牛码" || value.formatVersion !== DISASTER_FORMAT_VERSION || typeof value.recoveryPointId !== "string" || !value.recoveryPointId) throw new Error("灾备恢复点清单格式不正确");
