...
import { Bot, LibraryBig, Menu, Redo2, Sparkles, Trash2, Undo2, Upload } from "lucide-react";
                ...
                <div className="canvas-topbar-left pointer-events-auto flex min-w-0 items-center gap-2 sm:gap-3">
                    <Dropdown
                        ...
                        menu={{
                            ...
                            items: [
                                { key: "workbench", icon: <Sparkles className="size-4" />, label: "我的画布", onClick: onWorkbench },
                                { type: "divider" },
