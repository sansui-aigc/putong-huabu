        ...
        >
            ...
            <div className="mt-2 flex min-w-0 flex-wrap items-center gap-2">
                ...
                <Button
                    ...
                    title={!isRunning && !prompt.trim() ? "请先输入图片生成或修改提示词" : undefined}
            ...
            <div className="contents" onClick={stopCanvasInteraction} onDoubleClick={stopCanvasInteraction} onMouseDown={stopCanvasInteraction} onPointerDown={stopCanvasInteraction} onWheel={stopCanvasInteraction} onContextMenu={stopCanvasInteraction}>
                ...
                >
                    ...
                    <div className="mt-3 flex items-center justify-end gap-2">
                        ...
                        <Button type="primary" danger={isRunning} disabled={!isRunning && !prompt.trim()} title={!isRunning && !prompt.trim() ? "请先输入图片生成或修改提示词" : undefined} onClick={() => (isRunning ? onStop(node.id) : submitExpanded())} aria-label={isRunning ? "停止生成" : "生成"}>
                            {isRunning ? "停止生成" : "生成"}
                        </Button>
                    </div>
                </Modal>
