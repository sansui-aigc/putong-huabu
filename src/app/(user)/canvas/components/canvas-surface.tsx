...
export function CanvasSurface({
    ...
    const handleNodeMouseDown = useCallback(
        ...
        [onDragStateChange, setSelection, readOnly],
    );
    ...
    return (
        <div
            ...
            onClickCapture={(event) => {
                if (readOnly && (event.target as Element).closest("[data-node-id] button,[data-node-id] input,[data-node-id] textarea")) { event.preventDefault(); event.stopPropagation(); }
            }}
            onDoubleClickCapture={(event) => { if (readOnly) { event.preventDefault(); event.stopPropagation(); } }}
