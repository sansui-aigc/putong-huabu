...
export function canvasImagePreferenceSummary(preferences: GenerationPreferences, fixedSizeLabel?: string) {
    ...
    const quality = ({ auto: "智能", high: "4K", medium: "2K", low: "1K" } as Record<string, string>)[image?.quality || "auto"] || image?.quality || "智能";
...
function imageQualityLabel(value?: string) {
    return ({ auto: "智能", high: "4K", medium: "2K", low: "1K" } as Record<string, string>)[value || "auto"] || value;
}
