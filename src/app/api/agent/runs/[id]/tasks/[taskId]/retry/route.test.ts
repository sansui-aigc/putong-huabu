...
describe("Agent child task retry concurrency", () => {
    beforeEach(() => {
        ...
        mocks.getAuthSettings.mockResolvedValue({ ...structuredClone(DEFAULT_SETTINGS), generationConcurrency: { ...DEFAULT_SETTINGS.generationConcurrency, agent: 1 }, generationDefaults: { ...DEFAULT_SETTINGS.generationDefaults, imageSize: "1:1" } });
    });
