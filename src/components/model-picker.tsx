    ...
    return (
        ...
        >
            ...
            >
                ...
                <span data-slot="select-value" style={{ display: "block" }} className="canvas-model-picker-text min-w-0 flex-1 truncate text-left">{current ? modelOptionLabel(config, current) : placeholder}</span>
            </SelectTrigger>
            <SelectContent
                data-canvas-no-zoom
