...
import { STATIC_LOCAL_USER } from "@/stores/use-user-store";
...
export function initializeStandaloneSession() {
    const payload: PublicSessionPayload = {
        user: STATIC_LOCAL_USER,
        settings: { site: { title: "社会牛码创作工作台", logoUrl: "/logo.svg" } },
    };
