...
export function mapConversation(row: Record<string, unknown>): CreativeConversation {
    return {
        ...
        surface: row.surface === "canvas" ? row.surface : "chat",
        source: normalizeCreativeConversationSource(row.source) || creativeConversationSourceForSurface(row.surface === "canvas" ? row.surface : "chat"),
