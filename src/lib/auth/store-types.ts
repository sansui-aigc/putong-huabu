...
export type SystemChannelProtocol = "auto" | "openai" | "yumeng" | "gemini" | "sub2api" | "newapi" | "jui87" | "vozeb-recommended" | "globalaiopc" | "seedance" | "stable-diffusion" | "volcengine-video" | "seedance-special" | "custom" | "compatible";
...
export const DEFAULT_SITE_FRIEND_LINKS: SiteFriendLink[] = [
    { id: "vozeb-pro-home", label: "社会牛码", url: "https://www.vozeb.com/", enabled: true },
